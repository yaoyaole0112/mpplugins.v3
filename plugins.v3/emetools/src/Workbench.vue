...
function mediaScanScopeLabel() {
  ...
  return names.length > 2 ? `${names.slice(0, 2).join('、')}等 ${names.length} 个媒体库` : `${names.join('、')}媒体库`
}
...
.eme-media-scan-actions{display:flex;align-items:flex-start}.eme-media-scan-status{min-width:0;flex:1 1 280px;white-space:normal;overflow-wrap:anywhere;line-height:1.6}
