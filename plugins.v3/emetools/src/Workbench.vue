  ...
  <div class="eme-shell">
    ...
    <main class="eme-main">
      ...
      <template v-if="active === 'invalid'">
        ...
        <section class="eme-card"><div class="eme-card-heading"><div><h3>定时清理</h3><p>由 MoviePilot 调度；需要确认时先生成待办并发送 MoviePilot 通知，不直接清理。</p></div><button class="eme-button primary" :disabled="busy" @click="saveSchedule('tools')">保存任务</button></div>
